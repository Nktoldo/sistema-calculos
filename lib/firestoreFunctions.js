...
function getAllComissoes(empresa) {}

function getComissaoByPedido(pedidoId, empresa) {}

function getComissaoByProduto(produtoId, empresa) {}

function getComissaoByPedidoProduto(pedidoId, produtoId, empresa) {}
...
async function editComissaoProduto(ticketList, empresa) {
    try {
        ...
        console.log(`Erro ao tentar remover tickets de comissao: ${err}`)
    }
    
    await setComissao(ticketsList, empresa);
}

function removeComissaoPedido(pedidoId, empresa) {}

function removeComissaoPedidoProduto(pedidoId, produtoId, empresa) {}

function removeComissaoPedidoProdutoVendedor(pedidoId, produtoId, vendedorId, empresa) {}
